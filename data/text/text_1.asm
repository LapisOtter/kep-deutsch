...
_NoNibbleText::
	text "Nicht einmal" ; I removed the "alter Stiefel" part so the player can mash through it faster, replacing it with text from gen 2
	line "angeknabbert!" ; a bit unfortunate, though. it was charming
	prompt
