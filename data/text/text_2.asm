...
_TradeTransferredText::
	text "@" ; removed the "sein" for gender neutrality
	text_ram wcd6d
	text_start
...
_DexRatingText::
	text "#DEX-Bewertung<COLON>" ; was just a text_start followed by done in the original german version
	done
...
_CinnabarGymQuizIntroText::
	text "#MON-Quiz!"
	line "Laß uns beginnen!"	; Removing the unnecessarily long text that appears every single time
	prompt
...
_ScarletBook2::
	text "SANDFELL"
	line "Ein Theropoden-"
	cont "artiger Verwand-"
	cont "ter von MAGNETON."
...
_ViridianBlackboardSleepText:: ; decided to rewrite that one to make a bit more sense ~Lapis
	text "Wenn ein #MON"
	line "schläft, kann es"
	cont "nicht angreifen!"

	para "Es wacht im Kampf"
	line "irgendwann von"
	cont "selbst auf, wird"
	cont "das #MON"
	cont "ausgewechselt"
	cont "oder der Kampf"
	cont "geht zuende, dann"
	cont "wacht es von"
	cont "selbst nicht auf!"
...
_ViridianBlackboardPoisonText::
	...
	para "Ist das #MON"
	line "schwer vergiftet,"
	cont "verliert es jede"
	cont "Runde immer mehr"
	cont "Kraftpunkte!"
...
_ViridianBlackboardPrlzText::
	...
	line "#MON setzt"
	cont "im Kampf manchmal"
	cont "eine Runde aus!"
	
	para "Sein INITIATIVE-"
	line "Wert sinkt auch!"
...
_ViridianBlackboardFrozenText::
	...
	para "Der EISHEILER" ; Removed the "Nur" as items like Full Heal and Full Restore can heal Freeze too
	line "kann es wieder"
	cont "auftauen!"
	prompt
...
_DiglettSculptureText::
	text "Das ist ein" ; restored JP elemement
	line "Butsudan!"
	done
...
_HurtByLeechSeedText::
	text "Die EGELSAMEN-" ; took the correction from "SCHMAROTZER" to "EGELSAMEN" from Crystal to avoid confusion
...
_FlinchedText::
	text "<USER>"
	line "schreckt zurück!" ; changed the erroneous "ist ausgewichen!" to what it says Crystal onwards
	prompt
...
_HookedMonAttackedText::
	text "Das geangelte" ; changed "gefangene" to "geangelte" as the former implies it has been caught with a pokeball
	line "@"
	text_ram wEnemyMonNick
	text_start
	cont "greift an!"
