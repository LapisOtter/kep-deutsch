...
_LanceRematchText::
	...
	line "hier zu sehen!"
	cont "Dank dir ist der"
	cont "Ruf der #MON-"
	cont "LIGA in luftige"
	cont "Höhen geschnellt."
	
	para "Als Drachenprofi"
	line "und Oberhaupt der"
	cont "TOP VIER werde"
	cont "ich natürlich"
	cont "versuchen, diesem"
	cont "Ruf gerecht zu"
	cont "werden und mein"
	cont "bestes geben!"
	done
...
_LanceRematchAfterBattleText::
	text "Aber... Aber..."
	line "Mein Drachenheer"
	cont "sollte hätte doch"
	cont "eigentlich den"
	cont "Sieg davontragen"
	cont "sollen...!"
	
	text "Das zeigt wohl"
	line "deutlich, dass Du"
	cont "einfach eine"
	cont "Klasse für Dich"
	cont "bist."
	
	text "Du weißt ja, was"
	line "Dich jetzt"
	cont "erwartet..."
	
	text "Ich hoffe, Du bist"
	line "bereit für Deinen"
	cont "bisher größten"
	cont "Kampf!"
	text_end