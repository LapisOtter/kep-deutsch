...
; commands that are used to go to the next set of credits texts.
	...
	db CRED_TRANS, CRED_FABRI, CRED_TEXT_FADE
	db CRED_PROGRAMMERS, CRED_MURAKAWA, CRED_FUKUI, CRED_TEXT_FADE
	db CRED_SPECIAL, CRED_HARADA, CRED_NAKAMICHI, CRED_TEXT
	db CRED_NOEPRODTEST, CRED_ZEHTAPPERT, CRED_NOAPRODTEST, CRED_HUDSONBUECHELE, CRED_TEXT_FADE
	...
	db CRED_KEP_THANKS, CRED_ENI, CRED_VORT, CRED_DR_LAVA, CRED_TEXT_FADE
	db CRED_KEP_DE_TRANS, CRED_LAPIS, CRED_KOWIAORI, CRED_LUCI, CRED_EINSTEIN, CRED_TEXT_FADE_MON
