...
CredToOota:
	db -6, "TOMOMICHI OOTA@"
CredEUStaff:
	db -8, "EUROPÄISCHES TEAM@" 		; credits from german version replacing the english team credits, starting here
CredEUCoord:
...
CredKEP:
	db -4, "KEP TEAM@" 					; KEP credits start here
CredKEPDevs:
	db -6, "KEP ENTWICKLER@"
CredPvK:
